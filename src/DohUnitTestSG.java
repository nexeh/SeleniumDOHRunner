...
public class DohUnitTestSG {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DohUnitTestSG unit = new DohUnitTestSG();
        unit.setup(args);
        unit.test();
    }
    ...
    public void test() throws InterruptedException {
    	...
    	String jsocoverUrl = this.seleniumURL + "/jscoverage.html";
    	
    	URL hubUrl = null;
		try {
			hubUrl = new URL("http://vdqr03p-023ae25:4444/wd/hub");
